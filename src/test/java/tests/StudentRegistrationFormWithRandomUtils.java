...
*/
    @Test
    void fillFormTest() {
        String varFirstName = getRandomString(10),
                varLastName = "Dmitruk",
                varUserEmail = getRandomEmail(),
                varGender = "Other",
                varBirthDay = "20",
                ...
                varCurrentAddress = getRandomMessage(20, 100),
                varState = "Haryana",
                varCity = "Panipat";

        Long   varUserNumber = getRandomLong(1000000000L, 9999999999L);
